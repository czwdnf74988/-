...
test.to_csv('iris_ck.csv')#中心化核矩阵
...
test.to_csv('iris_nk.csv')#标准化核矩阵
...
test.to_csv('iris_kcf.csv')#计算核矩阵
...
test.to_csv('iris_knf.csv')#得到核矩阵